                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item first">
                        <div class="portfolio-wrap">
                            <a href="RecentPeople/img1.jpeg" data-lightbox="portfolio">
                                <img src="RecentPeople/img1.jpeg" alt="Portfolio Image">
                            </a>
                            <form action = "loadingpagebrowse.php" method="post">
                                    <button name="test1" class = "filter-active" >Run God's Eye for this Person!</button>
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item second">
                        <div class="portfolio-wrap">
                            <a href="RecentPeople/img2.jpeg" data-lightbox="portfolio">
                                <img src="RecentPeople/img2.jpeg" alt="Portfolio Image">
                            </a>
                            <form action = "loadingpagebrowse.php" method="post">
                                    <button name="test2" class = "filter-active" >Run God's Eye for this Person!</button>
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item third">
                        <div class="portfolio-wrap">
                            <a href="RecentPeople/img3.jpeg" data-lightbox="portfolio">
                                <img src="RecentPeople/img3.jpeg" alt="Portfolio Image">
                            </a>
                            <form action = "loadingpagebrowse.php" method="post">
                                    <button name="test3" class = "filter-active" >Run God's Eye for this Person!</button>
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item first">
                        <div class="portfolio-wrap">
                            <a href="RecentPeople/img4.jpeg" data-lightbox="portfolio">
                                <img src="RecentPeople/img4.jpeg" alt="Portfolio Image">
                            </a>
                            <form action = "loadingpagebrowse.php" method="post">
                                    <button name="test4" class = "filter-active" >Run God's Eye for this Person!</button>
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item second">
                        <div class="portfolio-wrap">
                            <a href="RecentPeople/img5.jpeg" data-lightbox="portfolio">
                                <img src="RecentPeople/img5.jpeg" alt="Portfolio Image">
                            </a>
                            <form action = "loadingpagebrowse.php" method="post">
                                    <button name="test5" class = "filter-active" >Run God's Eye for this Person!</button>
                            </form>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 portfolio-item third">
                        <div class="portfolio-wrap">
                            <a href="RecentPeople/img6.jpeg" data-lightbox="portfolio">
                                <img src="RecentPeople/img6.jpeg" alt="Portfolio Image">
                            </a>
                            <form action = "loadingpagebrowse.php" method="post">
                                    <button name="test6" class = "filter-active" >Run God's Eye for this Person!</button>
                            </form>
                        </div>
                    </div>
                </div>
